...
本仓库的软件本体、配置和中文文档由北京航空航天大学作为著作权人，以 Apache License 2.0
...
Apache License 2.0 允许复制、使用、修改和分发本软件，并提供明确的贡献者专利许可；分发时
应提供许可证副本、标明对原文件的修改，并保留软件中仍然适用的版权、专利、商标和归属声明。
许可证不授予北京航空航天大学名称、简称、校名、校徽或其他标识的
商标及类似权利。
